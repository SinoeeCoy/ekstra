<?php
// File ini di-include dari sistemprofil_pembina.php
// Variabel $nama_pembina_edit sudah tersedia
...
if ($_POST) {
    ...
    if (isset($_FILES['foto']) && $_FILES['foto']['error'] == 0) {
        ...
        if (in_array($file_extension, $allowed_types)) {
            $foto_name = 'pembina_' . time() . '_' . uniqid() . '.' . $file_extension;
    ...
    if ($is_edit) {
        ...
        // Insert data baru
        $insert_query = "INSERT INTO profil_pembina 
